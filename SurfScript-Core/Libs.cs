...
namespace SurfEngine {
    ...
    public class GameObject
    {
       ...
       //}
        ...
        public string GetName() { return GetNameImpl(this.ID.ToString()); }
        ...
        {
            T component = new T();
            return HasComponentImpl(this.ID.ToString(), component.GetComponentType());
        }
    ...
    public class Animation : Component{
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public static extern int GetFpsImpl(string uuid);
        public int GetFps()
        {
            return GetFpsImpl(this.uuid.ToString());
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        public static extern void SetFpsImpl(string uuid, int fps);
        public void SetFps(int fps)
        {
            SetFpsImpl(this.uuid.ToString(), fps);
        }
