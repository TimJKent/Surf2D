...
namespace MechEngine {
	MeshRenderer3dComponent::MeshRenderer3dComponent(Object* object) : Component(object) {
	...
	MeshRenderer3dComponent::~MeshRenderer3dComponent() {
		
	}
	

	void MeshRenderer3dComponent::DrawUI() {
		ImGui::PushID("MeshRenderer3d");
		ImGui::Text("Mesh Renderer 3d");	
	...
	void MeshRenderer3dComponent::OnUpdate()  {
	...
	void MeshRenderer3dComponent::Save() {
	...
	void MeshRenderer3dComponent::Load() {
	
	}

	void MeshRenderer3dComponent::SaveRefComponents() {
	...
	void MeshRenderer3dComponent::LoadRefComponents() {
		std::string temp = "";
		int slot = 0;
	...
	void MeshRenderer3dComponent::OnDelete() {
		--m_TransformComp->RequiredCounter;
	}
}